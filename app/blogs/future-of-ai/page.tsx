    ...
    <div className="pt-28 md:pt-24 lg:pt-32 pb-8 md:pb-12 lg:pb-16 px-4 md:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <article className="prose prose-invert max-w-none text-black dark:text-gray-300 space-y-6 md:space-y-12">
          ...
          <h2 className="text-black dark:text-white font-bold text-2xl">Current State of AI in Legal Technology</h2>
          <p>
          ...
          <h2 className="text-black dark:text-white font-bold text-2xl">AI&apos;s Impact on Key Legal Processes</h2>
          <p>
          ...
          <h2 className="text-black dark:text-white font-bold text-2xl">Challenges in AI Adoption</h2>
          <p>

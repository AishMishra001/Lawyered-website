          ...
          <form className="space-y-8">
            ...
            <div className="flex items-start gap-3 pt-2">
              ...
              <label htmlFor="auth" className="text-xl text-white">
                I hereby authorise to send notifications via SMS, Email, RCS and others as per <a href="#" className="text-[#0891B2] underline">Terms of Services</a> | <a href="#" className="text-[#0891B2] underline">Privacy Policy</a>
              </label>
            </div>

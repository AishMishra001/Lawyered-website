...
function LotsHero() {
  ...
  return (
    <div className="relative w-full text-center py-38 h-screen" onMouseMove={!isMobile ? handleMouseMove : undefined} onMouseLeave={!isMobile ? handleMouseLeave : undefined}>

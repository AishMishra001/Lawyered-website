    ...
    <div className="relative w-full overflow-hidden" onMouseMove={!isMobile ? handleMouseMove : undefined} onMouseLeave={!isMobile ? handleMouseLeave : undefined}>
      ...
      <div className="relative px-4 md:px-26 z-10 max-w-8xl mx-auto py-32 grid md:grid-cols-2 gap-16 items-center h-screen">
        ...
        <div className="flex flex-col gap-6 pl-10">
          <h1 className="text-4xl font-bold text-black dark:text-white text-center md:text-left">Privacy Policy</h1>
          <p className="text-xl text-black dark:text-white leading-relaxed text-center md:text-left">
...
function PrivacyContent() {
  return (
    <div className="pb-16 px-4 md:px-26">
      <div className="max-w-8xl mx-auto text-black dark:text-white leading-relaxed space-y-14">
        {/* Intro Section */}
        <div className="space-y-6 text-base">
            <p className="text-black dark:text-white">LAST UPDATED - 25th February 2025</p>
        ...
        {/* 1. DEFINITION */}
        <div>
            <div className="text-lg  text-black dark:text-white mt-12 mb-6">1. DEFINITION.</div>
        ...
        {/* 2. CONSENT */}
        <div>
            <div className="text-lg   text-black dark:text-white mt-12 mb-6">2. CONSENT.</div>
        ...
        <div>
            <div className="text-lg  text-black dark:text-white mt-12 mb-6">5. TO WHOM WE MAY SHARE YOUR INFORMATION?</div>
        ...
        {/* 6. USER RIGHTS. */}
        <div>
            <div className="text-lg  text-black dark:text-white mt-12 mb-6">6. USER RIGHTS.</div>
        ...
        <div>
            <div className="text-lg  text-black dark:text-white mt-12 mb-6">7. DATA BREACH NOTIFICATION MECHANISM</div>
        ...
        <div>
            <div className="text-lg text-black dark:text-white mt-12 mb-6">8. DATA RETENTION AND DELETION.</div>
        ...
        {/* 9. SECURITY MEASURES. */}
        <div>
            <div className="text-lg  text-black dark:text-white mt-12 mb-6">9. SECURITY MEASURES.</div>
        ...
        <div>
            <div className="text-lg  text-black dark:text-white mt-12 mb-6">10. CHANGES TO THIS PRIVACY POLICY.</div>

  ...
  return (
    <div className="py-24 px-4 md:px-26">
      ...
      <div className="max-w-8xl mx-auto ">
        <h2 className="text-2xl md:text-4xl font-semibold text-[#00A2BB] dark:text-[#22D3EE] mb-8 text-center md:text-left">Supported By</h2>
        <div className="scroller " data-animated="true">
          <div className="scroller__inner ">
            {[...logos, ...logos].map((logo, index) => {
              ...
              return (
                <div key={`${logo.name}-${index}`} className="h-12 lg:h-18 w-36 lg:w-45 bg-[#F7F7F7] dark:bg-white flex items-center justify-center rounded-lg p-2 overflow-hidden flex-shrink-0 ">
                  <Image
                    src={logo.src}
                    alt={logo.name}
                    width={144}

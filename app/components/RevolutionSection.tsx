...
export function RevolutionSection() {
  ...
  return (
    <div className="pt-2 md:pt-24 px-4 md:px-26">
      <div className="max-w-8xl mx-auto text-left flex flex-col items-start">
        <h2 className="text-2xl md:text-4xl font-bold text-[#22D2EE] self-start">Be a Part of the Revolution</h2>

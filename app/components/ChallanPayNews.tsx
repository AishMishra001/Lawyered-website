    ...
    <div className="py-24 px-4 md:px-26">
      <div className="max-w-8xl mx-auto">
        <div className="flex justify-between items-center mb-12">
          <h2 className="text-2xl md:text-4xl font-semibold text-[#00A2BB] dark:text-[#22D3EE]">
            ...
            {extendedNewsData.map((article, index) => (
              ...
              >
                ...
                <div className="mt-auto flex justify-between items-center text-sm">
                  ...
                  <Link href={article.link} className="text-[#00A2BB] dark:text-[#22D3EE] text-lg hover:underline font-semibold" target="_blank">
                    Read More
                  </Link>
                </div>
              </div>
